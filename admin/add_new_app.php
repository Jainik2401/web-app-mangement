...
if(isset($_GET['application_id']) && !empty($_GET['application_id'])){
	...
	if (empty($result)){
		header('Location: add_new_app.php');
	}
} 
include 'header.php';
?>
	...
	<div class="row form-wrap">
        <div class="col-lg-8">
        	<div class="p-4 back-color">
        		<?php if(isset($_GET['application_id']) && !empty($_GET['application_id'])){ ?>
					<h3 class="	text-center mb-4">Update Application (#<?php echo $_GET['application_id']; ?>)</h3>
				<?php } else { ?>
		    	...
		    	<form action="" id="app-reg-form" method="POST">
					...
					<div class="form-group row">
						<label for="input-companyname" class="col-sm-3 col-form-label">Comapany Name<span class="text-danger">*</span></label>	
							...
							<div class="col-sm-9">
	                           <select class="js-example-basic-single" name="companyname">
	        		...
	        		<div class="form-group row">
	        			<label for="input-catagory" class="col-sm-3 col-form-label">App Aproval</label>
	        			<div class="col-sm-9 mt-1" >
	        				<input type="checkbox" name="aproval-switchstatus" value="1" id="switch4" switch="bool" <?php if($result['app_aproval'] == 1 ) {echo 'checked';} ?>>
	        				<label for="switch4" data-on-label="Approve" data-off-label="Disaprove "></label></div>
	        		</div>

	        		<div class="form-group row">
	        			<label for="input-catagory" class="col-sm-3 col-form-label">App Trending</label>
	        			<div class="col-sm-9 mt-1" >
	        				<input type="checkbox" name="trend-switchstatus" value="1" id="switch5" switch="bool"
	        				<?php if($result['trending'] == 1 ) {echo 'checked';} ?>>
	        				<label for="switch5" data-on-label="Trending" data-off-label="Remove"></label></div>
	        		</div>
