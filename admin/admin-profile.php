				...
				<div class="col-md-6">
    					...
    					<form method="post"  id="change-profile-form">
							<div class="form-group row">
								<label for="input-username" class="col-sm-3 col-form-label">User Name</label>
								<div class="col-sm-9">
					        		<input type="text" class="username-formcontrol" id="input-username" name="username" value="<?php echo $result['username']; ?>" disabled />
					        	</div>
				    		</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
					        		<input type="text" class="form-control" id="input-email" name="email" value="<?php echo $result['email']; ?>" disabled />
					        	</div>
				    		</div>
