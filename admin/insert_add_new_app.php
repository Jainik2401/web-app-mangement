...
$trend_switchstatus = isset($_POST['trend-switchstatus']) ? $_POST['trend-switchstatus'] : 0;
...
if(isset($_POST['application_id']) && !empty($_POST['application_id'])) {
	...
	$insert = $conn->query("UPDATE applications SET category_id=".$category.", app_manager_id=".$companyname.", name='".$appname."', description='".$appdescription."',url='".$appurl."',support_url='".$supporturl."', app_status='".$status_switchstatus."', app_aproval='".$aproval_switchstatus."',trending='".$trend_switchstatus."' WHERE application_id='" . $_POST['application_id'] . "' ");
	...
	$insert = $conn->query("INSERT INTO applications SET category_id=".$category.", app_manager_id=".$companyname.", name='".$appname."', description='".$appdescription."',url='".$appurl."',support_url='".$supporturl."', app_status='".$status_switchstatus."', app_aproval='".$aproval_switchstatus."',trending='".$trend_switchstatus."', date_added=NOW()");
